...
class Ranges {
   ...
   * @returns {R}
   */
  static range (start: number): R;
  static range (start: number, end: number): R;
  static range (start: number, end: number, step: number): R;
  static * range (start: number, end?: number, step?: number): R {
    if (end === undefined) {
   ...
   * @returns {number[]}
   */
  static rangeToArray (range: R): number[] {
